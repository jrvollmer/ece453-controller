...
const PeripheralDetailsScreen = ({ route }) => {
    ...
    const renderCharacteristicsForService = (serviceUUID) => {
        ...
        return characteristics
            ...
            .map((char, index) => (<View key={index} style={styles.characteristicContainer}>
    ...
    return (<ScrollView style={styles.scrollViewStyle} contentContainerStyle={styles.contentContainer}>
            ...
            {peripheralData.services?.map((service, index) => (<View key={index} style={styles.serviceContainer}>
